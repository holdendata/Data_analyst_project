...
--and vaccinations to see the effectivess 
-- to see the effectiveness of these vaccinations 
--date 9/3/2022
...
location,
total_cases, 
(total_cases/population)*100 AS percentage_infection
FROM  dbo.covid_death_data
...
FROM dbo.covid_death_data as dea
inner join 
dbo.covid_vaccinations as vac
